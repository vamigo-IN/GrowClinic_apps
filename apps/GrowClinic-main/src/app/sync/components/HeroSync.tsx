            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col items-center text-center">
                    ...
                    <m.h1 
                        ...
                        className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-[0.95] tracking-tighter"
                    >
                        Automate Your Clinic <br />
                        <span className="text-gradient">With Sync</span>
                    </m.h1>
                    ...
                    >
                        <Button 
                            variant="primary" 
                            className="w-full sm:w-auto text-lg px-12 py-5 rounded-[15px] shadow-glow flex items-center justify-center gap-3 group"
                        ...
                        <button className="flex items-center gap-4 text-white font-black uppercase text-xs tracking-widest group hover:text-accent transition-colors">
                            <div className="w-14 h-14 rounded-[15px] bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-accent group-hover:text-white transition-all shadow-xl backdrop-blur-sm">
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { title: "Enterprise Security", desc: "Enterprise-grade encryption", icon: ShieldCheck },
                                { title: "Instant Setup", desc: "Go live in under 24 hours", icon: Zap },
                                { title: "Built to Scale", desc: "Powers 50+ clinics worldwide", icon: Globe },
                            ].map((item, i) => (
                                <div key={i} className="flex flex-col items-center md:items-start p-8 rounded-[15px] bg-white/5 border border-white/10 backdrop-blur-xl group hover:bg-white/[0.08] transition-all duration-500">
