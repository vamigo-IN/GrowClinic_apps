            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
                    {problems.map((problem, index) => (
                        ...
                        >
                            <Card className="p-8 h-full rounded-[15px] border border-slate-100 bg-slate-50/30 hover:bg-white hover:border-white transition-all duration-500 group" hoverEffect>
                                <div className={`w-14 h-14 ${problem.bg} rounded-[15px] flex items-center justify-center mb-8 group-hover:scale-110 transition-transform`}>
