            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mt-24 relative">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="w-20 h-20 mx-auto bg-[#1a1f26] rounded-[15px] border border-white/10 flex flex-col items-center justify-center shadow-2xl group-hover:border-primary group-hover:bg-primary/20 transition-all duration-500 mb-8 z-10 relative group-hover:-translate-y-2">
