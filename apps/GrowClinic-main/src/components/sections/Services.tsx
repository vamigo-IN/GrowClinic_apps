...
export function Services() {
    const services = [
        ...
        },
        {
            ...
            desc: "High-speed, secure websites designed to convert visitors into booked appointments.",
            icon: Monitor
        },
        {
    ...
    return (
        <section id="services" className="py-32 bg-slate-50 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <SectionHeading
                    title={<>Growth Solutions For <br /><span className="text-gradient">Ambitious</span> Practices</>}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <AnimatedSection
                            ...
                            delay={index * 0.1}
                        >
                            <Card className="group h-full p-1 w-full bg-white border border-slate-100 rounded-[15px] shadow-sm hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-2 overflow-hidden" hoverEffect>
                                <div className="p-8">
                                    <div className="w-16 h-16 bg-slate-50 rounded-[15px] flex items-center justify-center mb-8 group-hover:bg-primary group-hover:text-white transition-all duration-500">
                ...
                >
                    <Button variant="primary" className="text-xl px-12 py-5 shadow-glow rounded-[15px]" href="/contact">
