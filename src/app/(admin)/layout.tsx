    ...
    <div className="min-h-screen bg-slate-50/50 flex font-sans selection:bg-primary/20">
      ...
      <aside className="w-[280px] bg-white/70 backdrop-blur-xl border-r border-slate-200/60 flex flex-col shadow-[4px_0_24px_-12px_rgba(0,0,0,0.08)] z-20">
        ...
        <nav className="flex-1 p-5 space-y-1.5 overflow-y-auto">
          ...
          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 mt-6 px-4">Account & Settings</div>
          ...
          <Link href="/admin/settings" className="group flex items-center gap-3 px-4 py-3 text-slate-600 rounded-xl hover:bg-white hover:text-primary hover:shadow-sm hover:ring-1 hover:ring-slate-100 transition-all duration-200 font-medium">
