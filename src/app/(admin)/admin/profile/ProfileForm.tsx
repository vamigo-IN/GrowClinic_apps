  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-2xl">
      <div className="p-8 border-b border-gray-50 bg-gray-50/50">
        ...
        <p className="text-sm text-gray-500 mt-1">Update your display name and administrative password.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              disabled
              className="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-500 sm:text-sm cursor-not-allowed"
            />
            <p className="mt-1.5 text-xs text-gray-400 font-medium">Email address cannot be changed. This is your primary identity marker.</p>
          </div>

          <div>
            <label htmlFor="name" className="block text-sm font-bold text-gray-700 mb-1.5">Display Name</label>
            <input
              type="text"
              id="name"
              name="name"
              ...
              required
              className="block w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary sm:text-sm transition-colors"
        ...
        <div className="pt-6 border-t border-gray-100">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="newPassword" className="block text-sm font-bold text-gray-700 mb-1.5">New Password <span className="text-gray-400 font-normal">(Optional)</span></label>
              <input
                type="password"
                id="newPassword"
                name="newPassword"
