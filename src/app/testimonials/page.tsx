...
export const metadata: Metadata = {
  ...
  description: "Explore the real-world impact GrowClinic has delivered for elite medical practices. Real results, real growth, real stories.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-24">
          <SectionHeading
            ...
            subtitle="Explore the real-world impact we've delivered for elite medical practices across the country."
            centered
          />
        </div>
        ...
        {testimonials.length === 0 && (
          <div className="text-center py-32 bg-white rounded-[3.5rem] shadow-3xl border border-dashed border-slate-200">
