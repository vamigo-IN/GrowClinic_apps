            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    {videos.map((video, index) => (
                        <div key={index} className="rounded-2xl overflow-hidden relative group cursor-pointer aspect-video bg-gray-800">
                ...
                {/* Logos Grid */}
                <div className="mt-24">
                    <p className="text-center text-gray-400 mb-8 uppercase tracking-widest text-sm font-semibold">Trusted by over 500+ Clinics & Hospitals</p>
