...
const steps = [
    ...
    },
    {
        ...
        desc: "WhatsApp automation that captures leads and reduz no-shows instantly.",
        icon: MessageCircle
    },
    {
    ...
    return (
        <section className="py-32 bg-white relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <SectionHeading 
                    title={<>Proven <span className="text-gradient italic">Acquisition</span> Framework</>}
                ...
                <div className="mt-24 relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-16 relative z-10">
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="w-20 h-20 rounded-[2rem] bg-slate-50 border border-slate-100 flex items-center justify-center shadow-xl shadow-slate-200/50 mb-8 relative group-hover:bg-primary group-hover:text-white transition-all duration-500 hover:-translate-y-2">
