            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-stretch justify-center gap-8">
                    ...
                    <motion.div 
                        ...
                        className="bg-primary-gradient text-white rounded-[3rem] p-10 shadow-2xl shadow-primary/30 flex flex-col justify-center min-w-[320px] relative overflow-hidden group"
                    >
                        ...
                        <h3 className="text-4xl font-black leading-tight relative z-10">
                            Engineered <br /> 
                            <span className="text-white/60">For Rapid</span> <br /> 
                            Growth
                        </h3>
                        <p className="mt-6 text-white/80 font-medium relative z-10 max-w-xs">
                            We don't just do marketing. We build acquisition machines that scale hospitals.
                        </p>
                    </motion.div>
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 relative">
                        {props.map((prop, index) => (
                            ...
                            >
                                <Card className="group h-full p-8 rounded-[2.5rem] bg-slate-50 border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-primary/5 hover:bg-white transition-all duration-500 hover:-translate-y-2" hoverEffect>
                                    <div className="flex items-start gap-6">
                                        <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-500">
