      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <SectionHeading
            ...
            subtitle="Explore how we've engineered growth for elite medical practices."
            centered={false}
            className="mb-0"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {testimonials.map((testimonial, i) => (
            <motion.div 
              ...
              className="group bg-white p-10 rounded-[3rem] shadow-3xl border border-slate-50 flex flex-col justify-between transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-3 relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-5 border-t border-slate-50 pt-8 mt-auto">
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center text-primary font-black overflow-hidden border-2 border-white shadow-md ring-4 ring-primary/5 transition-all group-hover:scale-110">
