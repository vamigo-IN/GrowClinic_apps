        ...
        <section className="relative min-h-[90vh] flex items-center justify-center bg-white pt-32 pb-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-5xl mx-auto">
                    ...
                    >
                        Check your Clinic <br className="hidden md:block" />
                        <span className="text-gradient-primary italic">Digital Health</span> Growth
                    </motion.h1>
                    ...
                    >
                        We help doctors and clinics get more patients online.
                        Join 100+ medical leaders who are growing their practice every day.
                    </motion.p>
                    ...
                    >
                        <Button variant="primary" className="group shadow-glow text-lg px-12 py-5 rounded-[2rem] transition-all hover:scale-105 active:scale-95" onClick={() => window.location.href = '#audit'}>
                            Check Health Score
                            <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                        </Button>
                        <Button variant="outline" className="text-lg px-12 py-5 rounded-[2rem] border-slate-200 hover:bg-slate-50 font-bold" onClick={() => window.location.href = '/projects'}>
                            View Case Studies
                        </Button>
                    </motion.div>
                    ...
                    >
                        {[
                            { icon: Users, label: "500k+ Leads Generated", color: "text-blue-500" },
                            { icon: ShieldCheck, label: "End to End Digital Marketing", color: "text-green-500" },
                            { icon: TrendingUp, label: "3.7x Average Account ROI", color: "text-accent" }
                        ].map((badge, i) => (
